...
class DlangUIHandler {
    constructor(served, colorDecorationBase) {
        this.served = served;
        this.colorDecorationBase = colorDecorationBase;
...
exports.DlangUIHandler = DlangUIHandler;
function toCSSColor(str) {
    if (str[0] == '#') {
        if (str.length == 8 + 1)
...
function mapCompletionType(type) {
    if (type == 1)
...
//# sourceMappingURL=dlangui.js.map