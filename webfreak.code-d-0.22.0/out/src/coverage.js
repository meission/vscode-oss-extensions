...
function pathToName(root, fspath) {
...
class CoverageAnalyzer {
    ...
    populateCurrent() {
        ...
        if (extension_1.config(editor.document.uri).get("enableCoverageDecoration", true)) {
    ...
    refreshStatusBar(editor) {
        if (this.gotCoverage && statusbar_1.checkStatusbarVisibility("alwaysShowCoverageStatus", editor))
