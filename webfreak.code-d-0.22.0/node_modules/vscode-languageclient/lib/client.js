...
class SignatureHelpFeature extends TextDocumentFeature {
    ...
    registerLanguageProvider(options) {
        ...
        if (options.retriggerCharacters === undefined) {
            ...
            return vscode_1.languages.registerSignatureHelpProvider(options.documentSelector, provider, ...triggerCharacters);
        }
        else {
            const metaData = {
            ...
            return vscode_1.languages.registerSignatureHelpProvider(options.documentSelector, provider, metaData);
        }
    }
}
