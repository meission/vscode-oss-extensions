...
function getConfiguration() {
    return {
        ...
        disabledInEditor: vscode_1.workspace.getConfiguration('githd.editor').get('disabled'),
...
class Model {
    constructor(_gitService) {
        ...
        vscode_1.commands.executeCommand('setContext', 'disableInEditor', this._config.disabledInEditor);
        vscode_1.workspace.onDidChangeConfiguration(() => {
            ...
            if (newConfig.withFolder !== this._config.withFolder ||
                ...
                vscode_1.commands.executeCommand('setContext', 'disableInEditor', newConfig.disabledInEditor);
            }
    ...
    get onDidChangeConfiguration() { return this._onDidChangeConfiguration.event; }
