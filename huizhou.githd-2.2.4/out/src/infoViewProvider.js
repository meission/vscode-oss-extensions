        ...
        if (this._content) {
            ...
            this._content.split(/\r?\n/g).forEach(line => {
                if (line.substr(0, 7) == 'diff --') {
                    diffStarted = true;
                    utils_1.decorateWithoutWhitespace(pathRanges, line, i, 0);
                }
                    ...
                    utils_1.decorateWithoutWhitespace(oldLineRange, line, i, 0);
                }
                else if (line[0] == '+') {
                    utils_1.decorateWithoutWhitespace(newLineRange, line, i, 0);
                }
                else if (!diffStarted) {
                    utils_1.decorateWithoutWhitespace(infoRanges, line, i, 0);
                }
                ++i;
            });
