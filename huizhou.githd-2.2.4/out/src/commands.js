...
class CommandCenter {
    ...
    openCommittedFile(file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vscode_1.commands.executeCommand('vscode.diff', toGitUri(file.oldFileUri, leftRef), toGitUri(file.fileUri, rightRef), title + ' | ' + path.basename(file.gitRelativePath), { preview: true });
        });
    }
    ...
    _diffSelections({ repo, specifiedPath }) {
        return __awaiter(this, void 0, void 0, function* () {
            const branches = yield selectBranch(this._gitService, repo, true);
